...
class ProjectTest(TestCase):
    def setUp(self):
        ...
        self.post = Project.objects.create(id=1, title='poster', photo='https://ucarecdn.com/0ccf61ff-508e-46c6-b713-db51daa6626e', description='desc',user=self.user, url='http://ur.coml')
